define(function () {
    ...
    var size = function (element, rect) {
        ...
        // animation actions
        Actions = {
            blink: function (element, progress, options) {
                // default settings
                if (!('count' in options)) {
                    options.count = 3;
                }
                // initialize
                if (!('visibleRatio_' in options)) {
                    options.visibleRatio_ = 0.6;
                }
                if (!('frequency_' in options)) {
            ...
            move: function (element, progress, options) {
                // default settings
            ...
            circleMotion: function (element, progress, options) {
                // default settings
            ...
            scaling: function (element, progress, options) {
                // default settings
                if (!('scale' in options)) {
                    options.scale = 2;
                }
